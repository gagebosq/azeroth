...
public class CollisionChecker {
    ...
    public int checkObject(Entity entity, boolean player) { // check if player is hitting object, and if it is, collision is true
        int index = 8;
        for (int i = 0; i < gp.obj.length; i++) {
            if (gp.obj[i] != null) {
                // get the entities in solid are position
